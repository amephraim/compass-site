...
from compass_tweets.models import Context,ContextInstance,ContextMember
...
def personal(request, form_class=TweetForm,
    ...
    #tweets = TweetInstance.objects.tweets_for(request.user).order_by("-contextid")
    tweets = TweetInstance.objects.all().order_by("-contextid")
